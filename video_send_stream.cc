...
VideoSendStream::VideoSendStream(
  ...
  std::cout << "---ylr VideoSendStream ctor\n";
...
VideoSendStream::~VideoSendStream() {
  ...
  RTC_DCHECK(!send_stream_);
    ...
    std::cout << "---ylr VideoSendStream dctor\n";
}
...
void VideoSendStream::ReconfigureVideoEncoder(VideoEncoderConfig config) {
  ...
  std::cout << "---ylr VideoEncoderConfig:  " << config.ToString() << std::endl;
    
//  rtc::scoped_refptr<const VideoEncoderConfig::EncoderSpecificSettings>  encoder_specific_settings = config.encoder_specific_settings;

//    const VideoEncoderConfig::EncoderSpecificSettings* settings = encoder_specific_settings.get();
    
//    if(const VideoEncoderConfig::Vp8EncoderSpecificSettings* vp8_settings = (const VideoEncoderConfig::Vp8EncoderSpecificSettings*)(settings)){
//        //VideoCodecVP8 specific = vp8_settings->specifics_;
//
//    }
